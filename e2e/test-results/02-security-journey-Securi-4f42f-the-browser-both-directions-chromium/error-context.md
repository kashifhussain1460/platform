...
- Name: 02-security-journey.spec.ts >> Security journey (§7.2) >> department isolation holds in the browser, both directions
- Location: tests\02-security-journey.spec.ts:37:7
